...
import "./Chat.css";
import  ChatContext  from "./ChatContext"; // Assuming you have ChatContext defined

const Chat = () => {
  const { userId } = useContext(ChatContext); // Assuming userId is available in ChatContext
  ...
  useEffect(() => {
    const userChatsRef = ref(db, `user_chats/${userId}/chats`); // Use userId from context
